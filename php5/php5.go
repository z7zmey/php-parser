...
yydefault:
	...
	case 474:
		...
		//line php5/php5.y:6325
		{
			...
			yylex.(*Parser).appendMetaToken(n, yyDollar[1].token, meta.DollarToken)
	...
	case 475:
		...
		//line php5/php5.y:6339
		{
			...
			yylex.(*Parser).appendMetaToken(n, yyDollar[2].token, meta.DollarToken)
