...
//line scanner/scanner.go:2363
	...
	st_case_4:
		...
		goto tr0
	tr6:
//line scanner/scanner.rl:130
		(lex.p) = (lex.te) - 1
		{
			lex.addSkippedToken(token, SkippedTokenTypeWhitespace, lex.ts, lex.te)
		}
		goto st118
	tr8:
		lex.cs = 118
