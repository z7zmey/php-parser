...
yystate22:
	...
	default:
		goto yyrule127
	case c >= '/' && c <= '9' || c >= 'A' && c <= 'Z' || c == '^' || c == '_' || c >= 'a' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate23
	}
...
yystate115:
	...
	case c == '.':
		goto yystate105
	case c == 'A' || c == 'C' || c == 'D' || c >= 'F' && c <= 'W' || c == 'Y' || c == 'Z' || c == '_' || c == 'a' || c == 'c' || c == 'd' || c >= 'f' && c <= 'w' || c == 'y' || c == 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate113
	case c == 'B' || c == 'b':
		goto yystate119
	case c == 'E' || c == 'e':
...
yystate116:
	...
	case c >= '0' && c <= '9':
		goto yystate116
	case c >= 'A' && c <= 'D' || c >= 'F' && c <= 'Z' || c == '_' || c >= 'a' && c <= 'd' || c >= 'f' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate113
	}
...
yystate119:
	...
	case c == '0' || c == '1':
		goto yystate120
	case c >= '2' && c <= '9' || c >= 'A' && c <= 'Z' || c == '_' || c >= 'a' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate113
	}
...
yystate121:
	...
	case c >= '0' && c <= '9' || c >= 'A' && c <= 'F' || c >= 'a' && c <= 'f':
		goto yystate122
	case c >= 'G' && c <= 'Z' || c == '_' || c >= 'g' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate113
	}
...
yystate534:
	...
	goto yystate535 // silence unused label error
yystate535:
	c = l.Next()
yystart535:
	switch {
...
yystart542:
	...
	case c >= '/' && c <= '9' || c >= 'A' && c <= 'Z' || c == '^' || c == '_' || c >= 'a' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate549
	case c >= '\x01' && c <= '#' || c >= '%' && c <= ',' || c == '.' || c >= ':' && c <= '@' || c == '\\' || c == ']' || c == '`' || c >= '{' && c <= '~':
		goto yystate543
	}
...
yystate551:
	...
	goto yystate552 // silence unused label error
yystate552:
	c = l.Next()
yystart552:
	switch {
...
yystate561:
	...
	default:
		goto yyrule157
	case c == 'A' || c >= 'C' && c <= 'W' || c == 'Y' || c == 'Z' || c == '_' || c == 'a' || c >= 'c' && c <= 'w' || c == 'y' || c == 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate560
	case c == 'B' || c == 'b':
		goto yystate563
	case c == 'X' || c == 'x':
...
yystate569:
	...
	goto yystate570 // silence unused label error
yystate570:
	c = l.Next()
yystart570:
	switch {
	...
	case c >= '/' && c <= '9' || c >= 'A' && c <= 'Z' || c == '^' || c == '_' || c >= 'a' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate572
	case c >= '\x01' && c <= '\t' || c >= '\v' && c <= '.' || c >= ':' && c <= '@' || c >= '[' && c <= ']' || c == '`' || c >= '{' && c <= '~':
		goto yystate571
	}
...
yystart575:
	...
	case c >= '/' && c <= '9' || c >= 'A' && c <= 'Z' || c == '^' || c == '_' || c >= 'a' && c <= 'z' || c >= '\u007f' && c <= 'ÿ':
		goto yystate581
	case c >= '\x01' && c <= '\b' || c == '\v' || c == '\f' || c >= '\x0e' && c <= '\x1f' || c >= '!' && c <= ',' || c == '.' || c >= ':' && c <= '@' || c >= '[' && c <= ']' || c == '`' || c >= '{' && c <= '~':
		goto yystate576
	}
