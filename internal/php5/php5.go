...
// line internal/php5/php5.y:4088
	...
	case 315:
		yyDollar = yyS[yypt-3 : yypt+1]
// line internal/php5/php5.y:4101
		{
			yyVAL.node = &ast.ExprArray{
				Node: ast.Node{
					Position: position.NewTokensPosition(yyDollar[1].token, yyDollar[3].token),
